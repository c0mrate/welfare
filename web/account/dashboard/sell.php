        ...
        <div class="level-right">
          <div class="level-item">
            <div class="buttons is-right">
              ...
              <a href="../account/login.php" target="_blank" class="button is-primary">
                <span>ปรื้นรายการซื้อขายสินค้าทั้งหมด</span>
              </a>
            </div>
          </div>
        </div>
                ...
                <tbody>
                  <?php foreach ($users as $user) : ?>
                    <tr>
                      ...
                      <td data-label="name">อัษฎาวุธ</td>
                      <td data-label="ProductName">
                        <ul>
                          <?php foreach ($user['order'] as $order) : ?>
                            <?php foreach ($order['product'] as $product) : ?>
                              <li><?= $product['ProductName']; ?> <?= $product['ProductSize']; ?> <?= $product['ProductColor']; ?></li>
                            <?php endforeach; ?>
                          <?php endforeach; ?>
                        </ul>
                      </td>
                      <td data-label="ProductQuality">
                        <ul>
                          <?php foreach ($user['order'] as $order) : ?>
                            <?php foreach ($order['product'] as $product) : ?>
                      ...
                      <td data-label="weight">0.00</td>
                      <td data-label="shipping">0.00</td>
                      <td data-label="total_">0.00</td>
                      <td data-label="Total">
                        <ul>
                          <li>540.00</li>
                        </ul>
