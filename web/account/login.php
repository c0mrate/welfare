...
<body>
                    ...
                    <div class="con-a-center">
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                                <a href="login.html" class="btn px-0 ml-3">
                                    <i class="fas fa-user text-landing" id="user-icon"></i>
                                </a>
                                <a href="cart" class="btn px-0 ml-3">
                                    <i class="fas fa-shopping-cart text-landing" id="user-icon"></i>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="account_body">
        <div class="account_container account_th" id="container">
            <div class="account_form-container account_sign-up-container">
                <form class="account_form" action="register.php" method="POST">
                    <h1 class="account_h1">สมัครสมาชิก</h1>
                    <span class="account_span"></span>
                    <input type="username" name="username" placeholder="Username" class="account_input" required />
                    <input type="email" name="email" placeholder="Email" class="account_input" required />
                    <input type="password" name="password" placeholder="Password" class="account_input" required />
                    <select name="role" class="account_input" required>
                        <option value="" disabled selected>Select role</option>
                        <option value="STU">Student</option>
                        <option value="PER">staff</option>
                    </select>
            ...
            <div class="account_form-container account_sign-in-container">
                <form class="account_form" action="login-script.php" method="POST">
                    <h1 class="account_h1">เข้าสู่ระบบ</h1>
                    <input type="username" name="username" placeholder="Username" class="account_input" required />
                    <input type="password" name="password" placeholder="Password" class="account_input" required />
                    <a href="#" class="account_a">Forgot your password?</a>
                    <button type="submit" class="account_button">ยืนยัน</button>
                </form>
            </div>
