        ...
        <div class="position-relative active" style="height: 750px;">
            ...
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 700px;">
                    <div class="banner_">
                        <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown nav-th">
                            ศูนย์ส่งเสริมสวัสดิการและสิ่งจูงใจ
                        </h1>
                        <span class="banner_box nav-th">พัฒนาคุณภาพชีวิต ขับเคลื่อนพันธกิจมหาวิทยาลัย</span>
                        <br>
                        <a href="store.html">
                            <button class="banner_buttons underline_text_ nav-th">เข้าสู่ร้านค้า</button>
                        </a>
                    </div>
                </div>
            </div>
