<?php
require_once('../checkingSecondDoor.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="/web/source/lib/animate/" rel="stylesheet">
    <link href="/web/source/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light" onclick="goBack()">Exit</button>
                    </div>
                    <div class="btn-group mx-2">
                        <button type="button" class="btn btn-sm btn-light">THB</button>
                    </div>
                    <div class="btn-group">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-dark bg-primary px-2">KMUTNB</span>
                    <span class="h1 text-uppercase text-primary bg-dark px-2 ml-n1">Store</span>
                </a>
            </div>
            <div class="col-lg-4 col-6 text-left">
            </div>
            <div class="col-lg-4 col-6 text-right">
                <p class="m-0">ติดต่อ</p>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="con-a-center">
                        ...
                        <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="detail" class="nav-item nav-link nav-th">รายละเอียดสินค้า</a>
                                <a href="status" class="nav-item nav-link nav-th">สถานะคำสั่งซื้อ</a>
                            </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">สินค้า แนะนำ</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="bg-light p-4">
                        <img src="source/img/kmutnb.png" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="source/img/kmutnb.png" alt="">
                    </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <!-- <p class="mb-4">ร้านสวัสดิการ</p> -->
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ อาคาร 46 ชั้น1 ร้านค้าสวัสดิการ 1518 ถนนประชาราษฎร์ 1 แขวงวงศ์สว่าง เขตบางซื่อ กรุงเทพมหานคร 10800.</p>
                <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>02-585-7910, 081-875-7910</p>
                <!-- <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>081-875-7910</p> -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>หน้าหลัก</a>
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>ร้านค้า</a>
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>สินค้าทั้งหมด</a>
                            <!-- <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i></a>
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i></a>
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i></a>
                            <a class="text-secondary" href="#"><i class="fa fa-angle-right mr-2"></i></a> -->
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="text-secondary text-uppercase mb-4">Account</h5>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Log in</a>
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Create Account</a>
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    ...
                    by
                    <a class="text-primary" href="">c0mrate</a>
                </p>
            </div>
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="source/img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script>
        function goBack() {
            ...
            var targetUrl = "http://c0mrate.sytes.net/";

            // Check if the current URL is the target URL
            if (url === targetUrl) {
            // If the URL is the target URL, go back one page in the browser history
            window.history.back();
            } else {
            // If the URL is not the target URL, keep going back until we find it
            while (true) {
                window.history.back();
